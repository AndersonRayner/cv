...
\item{\cventry
	...
	{ 
        \vspace{3pt} 
        \begin{itemize}
            \item Lead systems integrator, management and field deployment (DARPA LINC, JPL collaboration)
            ...
            \item Led flight operations for multistatic SAR multi-UAS experiments (DARTS, JPL collaboration) %\hfill {\color{blue}\href{https://igarss2021.com/view_paper.php?PaperNum=2261}{(IGARSS 2021)}}
            \item Overhauled design of low-level firmware and robotic hardware (DARPA SubT, JPL collaboration)
...
\item
{
    \textbf{Robotics}
        \vspace{3pt} 
        \begin{itemize}
			\item System integration for single and multi-vehicle robotics projects on land and in the air
            \item Field testing (including Field Lead) in extreme environments with limited time and resources
            \item System architecture of complex robotic systems with challenging SWaP constraints% consideration to hardware constraints, sensors placement and bandwidth, power constraints, serviceability, and field survivability
...
\begin{itemize}
    ...
    \item [17.] O’Connell, M., Cho, J., \underline{\textbf{Anderson, M.}}, Chung, S.-J., ``\textit{Learning-based Minimally-Sensed Fault-Tolerant Adaptive Flight Control},'' IEEE Robotics and Automation Letters, vol. 9, no. 6, pp. 5198-5205, June 2024, doi: 10.1109/LRA.2024.3389414
    
	\item[16.] Lee, C., Frennert, J. G., Gan, L., \underline{\textbf{Anderson, M.}}, Chung, S.-J, ``\textit{Online Self-Supervised Thermal Water Segmentation for Aerial Vehicles},`` 2023 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS), 2023. \textit{Nominated Best Paper (Agri-Robotics)}
    ...
    \item [5.] Bouman A., Nadan P., \underline{\textbf{Anderson, M.}}, Pastor D., Izraelevitz J., Burdick J., Kennedy B., ``\textit{Design and Autonomous Stabilization of a Ballistically-Launched Multirotor},'' 2020 IEEE International Conference on Robotics and Automation (ICRA), 2020.  \textit{Best Paper (Unmanned Aerial Vehicles)}
...
\begin{itemize}
    ...
    \item [3.] Lee$^\star$, C., \underline{\textbf{Anderson$^\star$, M.}}, Raganathan, N., Zuo, X., Do, K., Gkioxari, G. and Chung, S.-J., ``\textit{CART: Caltech Aerial RGB-Thermal Dataset in the Wild},'' Submitted to ECCV 2024
    
    \item [2.] Lee, C., Soedarmadji, S., \underline{\textbf{Anderson, M.}}, Clark, A. J., Chung, S.-J., ``\textit{Semantics from Space: Satellite-Guided Thermal Semantic Segmentation Annotation for Aerial Field Robots},'' Submitted to IROS 2024

    \item [1.] Lupu, E. S., Xie, F., Preiss, J., \underline{\textbf{Anderson, M.}}, Alindogan, J., Chung, S.-J., ``\textit{MAGIC-VFM - Meta Adaptive Control for Ground Vehicles with Visual Foundation Models},'' Submitted to IEEE Transactions on Robotics, 2024
...
\begin{itemize}
	\item [1.] \underline{\textbf{Anderso,n M.}}, Gonzalez M., Hughes E., Baker M., Chung S.-J, Stolper, E., ``\textit{Deployment of a UAV-Borne Flask-Based Sampler for Volcanic Gas and Water Sample Collection},'' IAVCEI Scientific Assembly, 2023
\end{itemize}
