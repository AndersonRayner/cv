...
\begin{itemize}
    ...
    \item [17.] O’Connell, M. and Cho, J., \underline{\textbf{Anderson M.}}, Chung, S.-J., ``\textit{Learning-based Minimally-Sensed Fault-Tolerant Adaptive Flight Control},'' IEEE Robotics and Automation Letters, 2024 (to appear)
...
\begin{itemize}
    ...
    \item [1.] Lupu, E. S., Xie, F., Preiss, J., \underline{\textbf{Anderson M.}}, Alindogan, J., Chung, S.-J., ``\textit{MAGIC-VFM - Meta Adaptive Control for Ground Vehicles with Visual Foundation Models},'' IEEE Transactions on Robotics, 2024
